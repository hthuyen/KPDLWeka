...
//        MyKnowleadgeModel model = new MyKnowleadgeModel("C:\\Program Files\\Weka-3-8-4\\data\\iris.arff");
//        System.out.println(model);
//        model.saveData("E:\\Data\\LTHDT\\Data\\iris.arff");
//        model.saveData2CSV("E:\\Data\\LTHDT\\Data\\iris_CSV.csv");

        // MyAprioriModel
//     MyAprioriModel model = new MyAprioriModel("C:\\Program Files\\Weka-3-8-4\\data\\supermarket.arff",
...
//        System.out.println(model);
//    MyAprioriModel model = new MyAprioriModel("C:\\Program Files\\Weka-3-8-4\\data\\weather.numeric.arff",
//                                "-N 10 -T 0 -C 0.9 -D 0.05 -U 1.0 -M 0.1 -S -1.0 -c -1",
//                                "-R 2-3");
//     
//        model.mineAssociationRules();
//        System.out.println(model);
        //MyFPGrowthModel
//        MyFPGrowthModel model = new MyFPGrowthModel("C:\\Program Files\\Weka-3-8-4\\data\\supermarket.arff",
//                "-P 2 -I -1 -N 10 -T 0 -C 0.8 -D 0.05 -U 1.0 -M 0.2",
//                "-R 1-9,11,57,70,79-81,88-89,98,100-102,107-114,116-120,122-130,137-179,189,192-199,201-216");
//        model.mineAssociationRules();
//        System.out.println(model);

//    MyFPGrowthModel model = new MyFPGrowthModel("C:\\Program Files\\Weka-3-8-4\\data\\weather.nominal.arff",
...
//    } 
        //RemovePercentage
//        MyKnowleadgeModel model = new MyKnowleadgeModel("C:\\Program Files\\Weka-3-8-4\\data\\iris.arff", null, null);
...
//        System.out.println(model.testset.toSummaryString());
        ...
        //MyDecisionTreeModel
        MyDecisionTreeModel model = new MyDecisionTreeModel("C:\\Program Files\\Weka-3-8-4\\data\\iris.arff",
                "-C 0.25 -M 2", null);
